...
python3 -m meds_pipeline.cli run --source mimic --components admissions,eds,diagnosis,procedure, medicines, demographics --cfg mimic.yaml --max-patients 100

# AHS medicines component (100 patients)
python3 -m meds_pipeline.cli run --source ahs --components admissions,eds,diagnosis,procedure, medicines, demographics --cfg ahs.yaml --max-patients 100
