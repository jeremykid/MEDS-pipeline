...
python3 -m meds_pipeline.cli run --source mimic --components ecgs,labs,admissions,eds,diagnosis,procedures,medicines,demographics --cfg mimic.yaml --progress --max-patients 100
